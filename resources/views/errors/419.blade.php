        ...
        <div class="mt-5 md:mt-0 md:col-span-2 mx-auto">
            <div class="mx-auto shadow overflow-hidden sm:rounded-md">
                <div class="p-4 px-4 py-5 bg-white sm:p-12 mx-auto">
                    <h1 class="font-extrabold text-6xl px-4 py-10 flex justify-center text-red-400">419 Expired </h1>
            ...
            <h1 class="font-extrabold text-6xl px-4 py-10 flex justify-center">Sorry, your session has been expired!</h1>
            <h1 class="font-extrabold text-6xl px-4 py-10 flex justify-center">Please refresh and try again</h1>
