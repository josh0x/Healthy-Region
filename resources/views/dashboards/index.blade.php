        ...
        <div class=" text-center mt-5 md:mt-0 md:col-span-2">
            ...
            <div class="w-full py-10 px-3 text-black">
                ...
                <form class="block uppercase tracking-wide text-gray-700 text-sm font-bold mb-2" type="get" action="{{ url('/search') }}">
                    @csrf
                    <input name="title"  type="search" placeholder="Search documents" class="appearance-none block w-full bg-gray-200 text-gray-700 border @error('title') border-red-500 @enderror border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
